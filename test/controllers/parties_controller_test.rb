...
class PartiesControllerTest < ActionController::TestCase
  ...
  test "should create party" do
    assert_difference('Party.count') do
      post :create, party: { cost: @party.cost, phone: @party.phone, what: @party.what, when: @party.when, where: @party.where, who: @party.who }
    end
  ...
  test "should update party" do
    patch :update, id: @party, party: { cost: @party.cost, phone: @party.phone, what: @party.what, when: @party.when, where: @party.where, who: @party.who }
    assert_redirected_to party_path(assigns(:party))
  end
